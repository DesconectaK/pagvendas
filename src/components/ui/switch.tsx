...
>(({ className, ...props }, ref) => (
  <SwitchPrimitives.Root
    className={cn(
      ...
      "data-[state=checked]:bg-primary data-[state=checked]:border-primary", // Track: White background, White border when checked
      "data-[state=unchecked]:bg-input data-[state=unchecked]:border-border", // Track: Dark Gray background, Mid Gray border when unchecked
      className
    )}
    {...props}
    ref={ref}
  >
    <SwitchPrimitives.Thumb
      className={cn(
        ...
        "data-[state=unchecked]:bg-foreground", // Thumb: White on dark (input) track
        "data-[state=checked]:bg-primary-foreground" // Thumb: Black on white (primary) track
      )}
    />
  </SwitchPrimitives.Root>
))
